...
S3bucket_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://clima-colombia/raw-data/humedad/"],
        "recurse": True,
    },
...
ChangeSchema_node2 = ApplyMapping.apply(
    ...
    mappings=[
        ...
        ("valorobservado", "string", "humedad", "float"),
...
S3bucket_node3 = glueContext.getSink(
    path="s3://clima-colombia/trusted-data/humedad/",
    connection_type="s3",
...
S3bucket_node3.setCatalogInfo(
    catalogDatabase="clima-colombia", catalogTableName="humedad"
)
